...
public class RobotCommands {
  ...
  public RobotCommands(GroundManager groundManager) {
    ...
    var requirementsList = List.of(groundManager.deploy, groundManager.intake, groundManager.singulator);
  ...
  public Command groundIntakeCommand() {
    return Commands.runOnce(groundManager::intakeRequest, gmRequirements).withName("GroundIntakeCoralCommand");
  }
