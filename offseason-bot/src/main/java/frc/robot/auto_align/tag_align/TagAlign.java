...
public class TagAlign {
  ...
  public void setLevel(ReefPipeLevel level, ReefPipeLevel preferredLevel) {
  ...
  public Pose2d getUsedScoringPose(ReefPipe pipe) {
    if (preferedScoringLevel.equals(ReefPipeLevel.L1)) {
      ...
      var pipePose = pipe.getPose(pipeLevel, localization.getPose());
      var rotatedPipePose =
    ...
    return pipe.getPose(pipeLevel, localization.getPose());
  }
